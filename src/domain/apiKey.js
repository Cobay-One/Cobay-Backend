// Immutable domain model for the ApiKey entity.

/**
 * A frozen ApiKey record identified by a stable integer id.
 */
export class ApiKey {
  /**
  ...
  withAmount(amountCents) {
    return new ApiKey({ ...this, amountCents });
  }
   ...
   */
  deactivate() {
    return new ApiKey({ ...this, active: false });
  }
  ...
  label() {
    ...
    return `ApiKey(#${this.id}, ${this.name}, ${state})`;
  }
}
