// Immutable domain model for the ReturnRequest entity.

/**
 * A frozen ReturnRequest record identified by a stable integer id.
 */
export class ReturnRequest {
   ...
   */
  rename(name) {
    return new ReturnRequest({ ...this, name });
  }
  ...
  withAmount(amountCents) {
    return new ReturnRequest({ ...this, amountCents });
  }
   ...
   */
  deactivate() {
    return new ReturnRequest({ ...this, active: false });
  }
  ...
  label() {
    ...
    return `ReturnRequest(#${this.id}, ${this.name}, ${state})`;
  }
}
