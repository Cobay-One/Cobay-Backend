// Immutable domain model for the Transaction entity.

/**
 * A frozen Transaction record identified by a stable integer id.
 */
export class Transaction {
  ...
  withAmount(amountCents) {
    return new Transaction({ ...this, amountCents });
  }
   ...
   */
  deactivate() {
    return new Transaction({ ...this, active: false });
  }
  ...
  label() {
    ...
    return `Transaction(#${this.id}, ${this.name}, ${state})`;
  }
}
