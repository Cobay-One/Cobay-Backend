// In-memory repository for PriceRule records.
// Stores PriceRule instances; see ../domain/priceRule.js.
...
export class PriceRuleRepository {
  constructor() {
    /** @type {Map<number, PriceRule>} */
    this._items = new Map();
  }

  /**
   * Insert or replace a record.
   * @param {PriceRule} item
   */
  add(item) {
